...
### 🎓 Проект 1: A/B-тест образовательного онбординга в финтехе (SollmaFin)
...
Позицию **Data Analyst** в продуктовой компании, где смогу:
- Глубоко погружаться в данные и находить точки роста продукта
- Работать с реальными бизнес-задачами и влиять на решения
- Развиваться в направлении продуктовой аналитики и data-driven подхода

**Формат**: Full-time, Remote/Hybrid, Product teams
...
[📧 Отправить на Email](mailto:your.email@example.com)  
[📄 Посмотреть резюме на HH](https://hh.ru/resume/your_id)
