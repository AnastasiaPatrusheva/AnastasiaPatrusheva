...
**Инструменты**: Python (pandas, scikit-learn), DuckDB, Parquet, звёздная схема, оконные функции SQL, Streamlit, Altair, GitHub Actions (CI); интервал Уилсона, Z-тест долей, KMeans  
**Результат**: Живой дашборд на Streamlit — 10 вкладок, 3 источника данных, ~26 000 матчей; тир-лист чемпионов по нижней границе Уилсона, значимые баф/нерф между патчами через Z-тест, сегментация игроков на архетипы (KMeans), прогноз winrate собранного состава и рейтинги через оконные функции SQL  
